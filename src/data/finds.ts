...
export const finds: KumiaFind[] = [
  { id: "v2-find-001", number: 1, editionLabel: "V2 FIND", visualLabel: "8 STARTING COMBINATIONS", slug: "cordless-tool-starter-setup", href: "/tools/cordless-tool-starter-setup", title: "Build your first cordless tool setup.", category: "TOOLS", hostItem: "DIY goals", testedItem: "Tool + battery starter setup", publishedAt: "2026-09-13" },
